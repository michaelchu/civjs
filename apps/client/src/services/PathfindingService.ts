 ...
 *
 * @reference reference/freeciv-web/freeciv-web/src/main/webapp/javascript/control.js - goto_request_map cache
 * @reference reference/freeciv-web/freeciv-web/src/main/webapp/javascript/packhand.js - handle_web_goto_path
