...
export const HudDialogContent: React.FC<React.ComponentProps<typeof DialogContent>> = ({
  ...
  <DialogContent
    className={cn(
      'z-[2000] flex h-[min(88vh,56rem)] max-h-[calc(100vh-1rem)] w-[calc(100vw-1rem)] max-w-none flex-col overflow-y-auto border-white/15 bg-slate-900/95 p-4 text-white shadow-2xl backdrop-blur-xl sm:h-[min(88vh,56rem)] sm:w-[min(94vw,96rem)] sm:p-6',
      className
    )}
    {...props}
  />
