...
const players: Record<string, Player> = {
  ...
  'player-2': {
    ...
    spaceshipState: { structurals: 4, components: 2, modules: 1, launchedTurn: 18, arrivalTurn: 30 },
  },
};
...
describe('SpaceRaceReport', () => {
  ...
  it('shows arrival state once the current turn reaches the arrival turn', () => {
    const arrivedPlayers = {
      ...players,
      'player-1': { ...players['player-1'], spaceshipState: { structurals: 16, components: 8, modules: 3, launchedTurn: 12, arrivalTurn: 20 } },
    };
