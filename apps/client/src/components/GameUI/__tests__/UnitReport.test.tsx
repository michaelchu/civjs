...
const units: Record<string, Unit> = {
  'unit-1': {
    id: 'unit-1', playerId: 'player-1', unitTypeId: 'warrior', x: 2, y: 3, hp: 100,
    movesLeft: 1, maxMoves: 1, veteranLevel: 1, homeCityId: 'city-1',
    upkeep: { food: 1, shields: 0, gold: 2 },
  },
  'unit-2': {
    id: 'unit-2', playerId: 'player-2', unitTypeId: 'scout', x: 6, y: 7, hp: 90,
    movesLeft: 0, veteranLevel: 0,
  },
};
...
describe('UnitReport', () => {
  it('shows own-unit upkeep and excludes foreign units', () => {
    render(<UnitReport open onOpenChange={vi.fn()} units={units} cities={cities} currentPlayerId="player-1" />);
