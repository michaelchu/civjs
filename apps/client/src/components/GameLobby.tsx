          ...
          <div className="flex items-center justify-between mb-6 flex-wrap gap-4">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm md:text-base">Choose a game to join</p>
              </div>
            </div>
            <button
              onClick={() => loadGames(true)}
              className="px-3 md:px-4 py-2 bg-primary hover:bg-primary/90 disabled:bg-primary/50 text-primary-foreground rounded-md transition-colors focus:outline-none focus:ring-2 focus:ring-ring shadow-sm text-sm md:text-base"
              disabled={isRefreshing}
            >
              {isRefreshing ? (
                <div className="flex items-center">
                  <div className="animate-spin w-3 h-3 md:w-4 md:h-4 border border-primary-foreground/30 border-t-transparent rounded-full mr-1 md:mr-2"></div>
