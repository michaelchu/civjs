...
| `aiiface.c`, `common/ai.h` callbacks                   | City/unit/player lifecycle and observed-state invalidation hooks                          | Missing                                                                                                                                                                             | Callback ordering and cache-invalidation tests                                |
...
| city-management advisors                                                            | Citizen allocation, specialists, worklists, and governor use                                                | Missing for AI — player-facing governor mechanics exist                                                                                                                    | Starvation, happiness, production, and specialist optimization fixtures   |
...
| `daiguard.c`                               | Persistent guard/charge assignment for cities and vulnerable units                                                              | Missing                                                                                                                                                                                                      | Assignment, invalidation, escort, and replacement tests                        |
| `daihunter.c`                              | Hunter role selection and high-value mobile target pursuit                                                                      | Missing                                                                                                                                                                                                      | Target qualification and pursuit tests                                         |
| `daiferry.c`                               | Ferry demand, boat/passenger rendezvous, embarkation, beachhead and amphibious movement                                         | Missing                                                                                                                                                                                                      | Cross-ocean expansion and invasion integration scenarios                       |
| `daiair.c`                                 | Fuel-aware basing, strike evaluation, bombing, air defense, and refueling                                                       | Missing                                                                                                                                                                                                      | Range/fuel/base/target-value fixtures                                          |
| `daiparadrop.c`                            | Safe and valuable paradrop target selection                                                                                     | Missing                                                                                                                                                                                                      | Capture, reinforcement, threat, and range fixtures                             |
