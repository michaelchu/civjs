...
| `daitech.c`                                                                         | Technology wants aggregated from governments, units, buildings, effects, threats, and goals                 | Partial — unit, building, government, city-count, and military-pressure wants propagate recursively through prerequisite chains into persisted research goals; already-obsolete unlocks are suppressed; effect and threat-specific recursion remains                                          | Classic tree scenario rankings, obsolescence, and goal persistence        |
