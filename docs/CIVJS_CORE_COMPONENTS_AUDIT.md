...
| Cities & population            | Founding, ownership/capture, city map, worked tiles, specialists, food/growth/starvation, production queues, buildings/wonders, happiness, corruption, trade, governor. | Authoritative city lifecycle and turn processing; persistent worklists; owner-controlled worked tiles and specialists; Freeciv population curve; present/supported units; production, buildings, trade, happiness, corruption, pollution, governor, city overview, rename, guarded disband, building sale, rush-buy, and bulk citizen optimization UI. | Partial — core classic city loop is implemented; advanced empire-report and batch-management parity remains |
