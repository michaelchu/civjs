...
| Cities & population            | Founding, ownership/capture, city map, worked tiles, specialists, food/growth/starvation, production queues, buildings/wonders, happiness, corruption, trade, governor. | Authoritative city lifecycle and turn processing; persistent and reusable worklists; owner-controlled worked tiles and specialists; Freeciv population curve; present/supported units; accurate report waste/corruption; production, buildings, trade, happiness, pollution and governor management; sortable/filterable empire report; rename, guarded disband, building sale, rush-buy; and server-authoritative batch production, worklist, governor, citizen optimization, buying, and selling. | Implemented                                                                           |
...
- **Empire management — Partial:** The client exposes the city list, production/growth/economy overview, individual management, and bulk citizen optimization alongside economy/rates, research, and government screens. Freeciv's richer city-report sorting, saved worklist templates, multi-city production editing, and equivalent batch/report controls remain lower-priority presentation gaps.
