...
| `game.json`        | `data/classic/game.ruleset`                      | Reproducibly converted and schema-validated in full. Initial state, city economy, research, upkeep, combat/nuclear parameters, borders, culture interest, calendar/timeline effects, visibility, and trade percentages drive runtime behavior; `ClassicGameRuleInventory` explicitly tracks preserved and partial sections. |
...
| `terrain.json`     | `data/classic/terrain.ruleset`                   | Loaded; movement costs, base yields, effect terrain context, and primary/alternate graphics drive playable-loop calculations and rendering.                                                                                                                                                                                 |
