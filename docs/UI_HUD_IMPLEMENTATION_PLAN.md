...
| -------------------------------------------------- | ------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0. Authoritative data contract and synchronization | **Complete** | Authoritative phase, score, economy rates, team/spaceship/culture fields, unit metadata, and city metadata are now propagated and normalized for HUD use. Legacy recovery score fallback and packet regression coverage are included. Faith, strategic-resource inventory, diplomacy coordinates, and rally points remain explicit backend data boundaries. |
...
| 7. Right diplomacy / leader strip                  | **Complete** | `DiplomacyStrip` supports known nations, relationship/proposal summaries, leader identity placeholders, embassy/shared-vision indicators, treaty actions, intelligence access, safe centering on a known visible city or unit, collapse, and mobile behavior. Unknown nations never receive inferred locations.                                             |
...
The persistent HUD milestone and Slice 0 data-contract prerequisite are
implemented. High-priority UI work can proceed from the HUD surfaces already
listed below. Faith, strategic-resource inventory, diplomacy coordinates, and
rally points still require future backend contracts and must not be inferred
in the UI. Diplomacy
