...
| -------------------------------------------------- | --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 0. Authoritative data contract and synchronization | **Partial / high priority** | Authoritative phase is propagated through game-start and turn-start packets. Score now uses one shared server calculation for live and active-game snapshot paths, with persisted-score fallback for legacy recovery data. Tax/luxury/science rates are exposed in both paths. Unit and city fields are largely present, but normalization coverage should be tightened. |
...
focus on completing the remaining Slice 0 normalization audit before
additional polish: verify FE normalization for the unit and city fields
already emitted by the BE and add any missing regression coverage. Score and
economy synchronization are now covered across live and active-game snapshot
paths. Diplomacy
